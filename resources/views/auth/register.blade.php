                    ...
                    <div class="part-form">
                        <form action="{{ route('register') }}" method="post" id="registerForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 my-1">
                                    <label for="referred_by" class="form-label">Referral Code</label>
                                    <input type="text" id="referred_by" name="referred_by" class="form-control" placeholder="Referral Code">
                                </div>
                            </div>
