                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="banner-content">
                        ...
                        <h1 class="title">choose a <span class="special">quick pick</span> for <span class="b-spc">Lotto
                                online</span></h1>
                        <div class="all-btns">
                            <a class='btn-pok' href='{{ route('landing.lottery') }}'>Play Lottery <i
                                    class="fa-solid fa-angle-right"></i></a>
                            <a class='btn-pok-2' href='{{ route('landing.about-us') }}'>Explore More <i
                                    class="fa-solid fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="part-picking-number">
                <div class="lotteries-selection-menu">
                    <ul>
                        <li>
                            <a class="single-lottery-item active" data-bs-toggle="tab" data-bs-target="#pills-numbers"
                ...
                <div class="animation-body animated">
                    <div class="picking-number-header">
                        <img src="{{ asset('assets/img/lottery/lottery-header-right-img.png') }}" alt=""
                            class="lottery-bg-img">
                        <div class="part-lottery-info">
                            <div class="part-img selected-lottery-logo">
                                <img src="{{ asset('assets/img/lottery/euro-jackpot-big.png') }}" alt="">
                            </div>
                            <div class="part-text">
                                <span class="lottery-name">{{ $lottery->lotteryMaster->lottery_name }}</span>
                                    ...
                                    <div class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-info-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-info" aria-selected="false">Prizes & info</button>
                                        </li>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            style="font-size: 34px;line-height: 44px;font-weight: 600;margin-top: -11px;margin-bottom: 2px; color: white">
                    ...
                    <div class="picking-number-body">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-numbers" role="tabpanel"
                                aria-labelledby="pills-numbers-tab">
                                <div class="picking-number-palate">
                                    <div class="number-box common">
                                        @foreach ($lottery->lotteryNumbers as $item)
                                ...
                                <div class="picking-number-final-step">
                                    ...
                                    <div class="part-btn">
                                        <button class='btn-pok'  id="continueToCart">Continue to cart <i
                    ...
                    <div class="about-text">
                        ...
                        <div class="part-bottom">
                            ...
                            <div class="part-descr">
                                ...
                                <a class='btn-pok' href='{{ route('landing.about-us') }}'>Know more <i
                                        class="fa-solid fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
